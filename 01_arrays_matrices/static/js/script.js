...
function reorNums() {
    ...
    let num2 = 2
    let suma = num1 + num2;
    let elem = datos.shift();

    alert(`${suma} ${datos.join(" ")} plácidamente`)
}
...
function limpiezaDatos() {
    ...
    let palabra = inventario.shift();
    let palabra2 = inventario.pop();
    let palabra3 = inventario.unshift("Monitor");
